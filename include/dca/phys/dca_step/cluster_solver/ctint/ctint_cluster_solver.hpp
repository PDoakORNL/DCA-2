...
protected:  // thread jacket interface.
  ...
  using Walker = ctint::CtintWalkerChoice<device_t, Parameters, use_submatrix, Scalar, DIST>;
  using Accumulator = ctint::CtintAccumulator<Parameters, device_t, Scalar, DIST>;
